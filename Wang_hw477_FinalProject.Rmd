...
## COVID-19 Death, Political Standing Map, and GDP

```{r COVID-19 Death, Political Standing Map, and GDP, echo = FALSE}
ggplot(data=plot3, aes(x=prob, y=yhat)) +
  geom_point(aes(color = model)) +
  ggtitle("Probability of Being Low Birth Weight") + 
  labs(y="Probability")
...
grid.arrange(state_choropleth(education_ForMap, title  = "Education Level in the US", zoom = continental_us_states),
             state_choropleth(political_Clinton_ForMap, title  = "Vote for Clinton in 2016 in the US", zoom = continental_us_states),
