...
Data Collection: scraping 5 tables from different websits
...
Data Cleaning: 4 tables, example as below (Political Standing table)
...
```{r Education & Political Standing, echo = FALSE}
# education for map
...
delete the outlier (District of Columbia)

```{r COVID-19, Population Density, and GDP, echo = FALSE, warning=FALSE}
# delete the outlier 
density_ForMap <- full %>%
